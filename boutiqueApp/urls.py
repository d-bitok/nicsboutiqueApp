...
from . import views
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, UserPostListView, ProductListView
...
urlpatterns = [
    ...
    path('', ProductListView.as_view(), name='Boutique-Store'),
